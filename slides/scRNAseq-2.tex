% !TEX program = xelatex
\documentclass[11pt,aspectratio=43]{ctexbeamer}
...
\titlegraphic{\includegraphics[width=2.5cm]{logo_tmu.png}}
\title{\huge{单细胞转录组学}}
\subtitle{\Large{scRNA-seq数据分析}}
\author{\vspace{-0.6cm}\large{伊现富（Yi Xianfu）}}
\date{\large{2024年7月12日}}
\institute{\centering{\large{基础医学院\vspace{0.1cm}\\ 生物信息学系\vspace{0.5cm}\\ 微是研究院研讨会\vspace{0.8cm}}}}
